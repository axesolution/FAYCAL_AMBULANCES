        ...
        <section className="relative h-[85vh] flex items-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-bold px-4 py-2 rounded-full mb-6 uppercase tracking-widest">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-white text-lg px-8 py-7 rounded-full transition-all hover:scale-105">
                  <a href="tel:+213123456789">{t.hero.callNow}</a>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white/10 text-lg px-8 py-7 rounded-full">
        ...
        <section className="py-24 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4 uppercase tracking-tight">{t.services.title}</h2>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-10 leading-tight">{t.whyUs.title}</h2>
                ...
                {t.whyUs.items.map((item, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex gap-8 group">
                      <div className="shrink-0 w-14 h-14 bg-blue-50 flex items-center justify-center rounded-2xl group-hover:bg-primary transition-colors">
        ...
        <section className="py-24 relative bg-primary overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Button asChild size="lg" className="bg-red-600 hover:bg-red-700 text-white rounded-full text-2xl px-12 py-10 shadow-2xl transition-all hover:scale-105 border-none">
                <a href="tel:+213123456789" className="flex items-center gap-4">
                  <Phone className="h-8 w-8 animate-tada" />
                  {t.cta.button}
                </a>
              </Button>
            </div>
